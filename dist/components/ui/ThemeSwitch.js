...
var ThemeSwitch = function () {
    ...
    return (<button aria-label='Toggle Dark Mode' type='button' className='ml-3  h-8 w-8 rounded p-1 lg:ml-4' onClick={function () {
            return setTheme(theme === 'dark' || resolvedTheme === 'dark' ? 'light' : 'dark');
        }}>
      <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' className='textHover text-gray-900 dark:text-gray-100'>
