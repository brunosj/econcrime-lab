...
var blogPreviews_1 = require("@/components/content/blogPreviews");
var BlogPage = function (_a) {
    var pages = _a.pages, blogs = _a.blogs;
    var page = pages.filter(function (page) { return page.attributes.slug === 'blog'; })[0];
    return (<layout_1.default>
      <seo_1.Seo title={"".concat(page.attributes.title, " |")} description={page.attributes.description}/>
      <article className=''>
        <pageHeaderTitle_1.default textColor='text-mblue-700 dark:text-mblue-500'>
          {page.attributes.title}
        </pageHeaderTitle_1.default>
        <pageContentGrid_1.default>
          <blogPreviews_1.default blogs={blogs.data}/>
        </pageContentGrid_1.default>
      </article>
    </layout_1.default>);
};
...
var getStaticProps = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, fetch("".concat(process.env.STRAPI_PUBLIC_API_URL, "pages?populate=*"))];
                case 1:
                    pagesResponse = _d.sent();
                    return [4 /*yield*/, pagesResponse.json()];
                case 2:
                    pages = _d.sent();
                    return [4 /*yield*/, fetch("".concat(process.env.STRAPI_PUBLIC_API_URL, "blog-items?locale=").concat(locale, "&populate=*"))];
                case 3:
                    res = _d.sent();
                ...
                case 4:
                    data = _d.sent();
                    _c = {};
                    _b = [{ pages: pages.data, blogs: data }];
