...
var coursesContent_1 = require("@/components/content/coursesContent");
var CoursesPage = function (_a) {
    var pages = _a.pages, courses = _a.courses;
    var page = pages.filter(function (page) { return page.attributes.slug === 'courses'; })[0];
    return (<layout_1.default>
      <seo_1.Seo title={"".concat(page.attributes.title, " |")} description={page.attributes.description}/>
      <section className=''>
        <pageHeaderTitle_1.default textColor='text-mturquoise-700 dark:text-mturquoise-500' svgBackground='textureBgTurquoise' description={page.attributes.description}>
          {page.attributes.title}
        </pageHeaderTitle_1.default>
        <pageContentGrid_1.default>
          <coursesContent_1.default courses={courses.data}/>
        </pageContentGrid_1.default>
      </section>
    </layout_1.default>);
};
...
var getStaticProps = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var pagesResponse, pages, res, data, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    pages = _d.sent();
                    return [4 /*yield*/, fetch("".concat(process.env.STRAPI_PUBLIC_API_URL, "courses?locale=").concat(locale, "&populate[problematics][populate][0]=pdf"))];
                case 3:
                    res = _d.sent();
                ...
                case 4:
                    data = _d.sent();
                    _c = {};
                    _b = [{ pages: pages.data, courses: data }];
