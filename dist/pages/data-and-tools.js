...
var dataToolsContent_1 = require("@/components/content/dataToolsContent");
var DataToolsPage = function (_a) {
    var pages = _a.pages, resources = _a.resources;
    var page = pages.filter(function (page) { return page.attributes.slug === 'data-and-tools'; })[0];
    return (<layout_1.default>
      <seo_1.Seo title={"".concat(page.attributes.title, " |")} description={page.attributes.description}/>
      <pageHeaderTitle_1.default textColor='text-myellow-700 dark:text-myellow-500' svgBackground='textureBgPurple' description={page.attributes.description}>
        {page.attributes.title}
      </pageHeaderTitle_1.default>
      <dataToolsContent_1.default data={resources}/>
    </layout_1.default>);
};
exports.default = DataToolsPage;
function getStaticProps(_a) {
    var locale = _a.locale;
    return __awaiter(this, void 0, void 0, function () {
        var pagesResponse, pages, dataResponse, resources, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    pages = _d.sent();
                    return [4 /*yield*/, fetch("".concat(process.env.STRAPI_PUBLIC_API_URL, "database-items?locale=").concat(locale, "&populate=*"))];
                case 3:
                    dataResponse = _d.sent();
                    return [4 /*yield*/, dataResponse.json()];
                case 4:
                    resources = _d.sent();
                    _c = {};
                    _b = [{ pages: pages.data, resources: resources.data }];
