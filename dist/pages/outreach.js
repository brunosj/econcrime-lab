...
var OutreachPage = function (_a) {
    var pages = _a.pages, outreach = _a.outreach;
    var page = pages.filter(function (page) { return page.attributes.slug === 'outreach'; })[0];
    var outreachSorted = outreach.sort(function (a, b) {
    ...
    return (<layout_1.default>
      ...
      <section className=''>
        ...
        <pageContentGrid_1.default>
          <outreachContent_1.default outreach={outreachSorted}/>
        </pageContentGrid_1.default>
      </section>
    </layout_1.default>);
};
exports.default = OutreachPage;
function getStaticProps(_a) {
    var locale = _a.locale;
    return __awaiter(this, void 0, void 0, function () {
        var pagesResponse, pages, outreachResponse, outreach, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    pages = _d.sent();
                    return [4 /*yield*/, fetch("".concat(process.env.STRAPI_PUBLIC_API_URL, "outreach-items?locale=").concat(locale, "&populate=*"))];
                case 3:
                    outreachResponse = _d.sent();
                    return [4 /*yield*/, outreachResponse.json()];
                case 4:
                    outreach = _d.sent();
                    _c = {};
                    _b = [{ pages: pages.data, outreach: outreach.data }];
