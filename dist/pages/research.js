...
var researchContent_1 = require("@/components/content/researchContent");
var pageContentGrid_1 = require("@/components/layout/pageContentGrid");
var layout_1 = require("@/components/layout");
var seo_1 = require("@/components/seo");
var ResearchPage = function (_a) {
    var pages = _a.pages, research = _a.research;
    var page = pages.filter(function (page) { return page.attributes.slug === 'research'; })[0];
    return (<>
      <seo_1.Seo title={"".concat(page.attributes.title, " |")} description={page.attributes.description}/>
      <layout_1.default>
        <pageHeaderTitle_1.default textColor='text-mpurple-700 dark:text-mpurple-500' svgBackground='textureBgPurple' description={page.attributes.description}>
          {page.attributes.title}
        </pageHeaderTitle_1.default>
        <pageContentGrid_1.default>
          <researchContent_1.default researchProjects={research}/>
        </pageContentGrid_1.default>
      </layout_1.default>
    </>);
};
...
function getStaticProps(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var pagesResponse, pages, researchResponse, research, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    pages = _d.sent();
                    return [4 /*yield*/, fetch("".concat(process.env.STRAPI_PUBLIC_API_URL, "researchs?locale=").concat(locale, "&populate[people_items][populate][0]=photo&populate[publication_items][populate]"))];
                case 3:
                    researchResponse = _d.sent();
                    return [4 /*yield*/, researchResponse.json()];
                case 4:
                    research = _d.sent();
                    _c = {};
                    _b = [{ pages: pages.data, research: research.data }];
