...
var peopleContent_1 = require("@/components/content/peopleContent");
var PeoplePage = function (_a) {
    var pages = _a.pages, people = _a.people;
    var page = pages.filter(function (page) { return page.attributes.slug === 'people'; })[0];
    return (<layout_1.default>
      <seo_1.Seo title={"".concat(page.attributes.title, " |")} description={page.attributes.description}/>
      <pageHeaderTitle_1.default textColor='text-mpurple-700 dark:text-mpurple-500' svgBackground='textureBgTurquoise' description={page.attributes.description}>
        {page.attributes.title}
      </pageHeaderTitle_1.default>
      <pageContentGrid_1.default>
        <peopleContent_1.default people={people}/>
      </pageContentGrid_1.default>
    </layout_1.default>);
};
...
function getStaticProps(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var pagesResponse, pages, peopleResponse, people, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    pages = _d.sent();
                    return [4 /*yield*/, fetch("".concat(process.env.STRAPI_PUBLIC_API_URL, "student-items?locale=").concat(locale, "&populate=photo&populate=research_projects&populate=researchInterests"))];
                case 3:
                    peopleResponse = _d.sent();
                    return [4 /*yield*/, peopleResponse.json()];
                case 4:
                    people = _d.sent();
                    _c = {};
                    _b = [{ pages: pages.data, people: people.data }];
